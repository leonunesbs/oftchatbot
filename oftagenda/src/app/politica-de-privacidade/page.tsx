...
export const metadata: Metadata = {
  ...
  description:
    "Política de privacidade da plataforma Minha Agenda em conformidade com a LGPD.",
  alternates: {
    ...
    <section className="mx-auto w-full max-w-3xl space-y-6">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <section className="space-y-2">
          ...
          <p>
            Esta política se aplica exclusivamente ao app{" "}
            <strong>{siteConfig.name}</strong> (
            <strong>{siteConfig.domain}</strong>), responsável pelo fluxo de
            agendamento online e gerenciamento da reserva.
          </p>
          <p>
            Se você acessou o agendamento a partir do site institucional do Dr.
            Leonardo (oftleonardo.com.br), consulte também a política específica
            daquele site em{" "}
            <Link
        ...
        <section className="space-y-2">
          ...
          <p>
            Esta Política descreve como a plataforma{" "}
            <strong>{siteConfig.name}</strong> trata dados relacionados ao uso
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            essenciais e, quando autorizado, para analytics e mensuração. Você
            pode escolher entre aceitar cookies opcionais ou manter apenas os
            essenciais no banner de consentimento.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Podemos compartilhar dados com operadores e parceiros tecnológicos
            estritamente necessários para operação da plataforma (por exemplo,
            infraestrutura, autenticação, analytics e pagamentos), sempre
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            O período de retenção varia conforme finalidade, exigências legais e
        ...
        <section className="space-y-2">
          ...
          <p>
            Para dúvidas ou solicitações relacionadas a dados pessoais, entre em
            contato pelo e-mail{" "}
            <Link
