...
export default defineSchema({
  ...
  appointment_details: defineTable({
    ...
    clerkUserId: v.string(),
    triageCiphertext: v.optional(v.string()),
    triageWrappedKey: v.optional(v.string()),
    triageIv: v.optional(v.string()),
    encryptionVersion: v.optional(v.literal("v1")),
    encryptionAlgorithm: v.optional(v.literal("RSA-OAEP/AES-GCM-256")),
    encryptionKeyVersion: v.optional(v.string()),
    reason: v.optional(triageReasonValidator),
    conditions: v.optional(v.array(conditionValidator)),
    symptoms: v.optional(v.array(symptomValidator)),
    lastDilation: v.optional(lastDilationValidator),
